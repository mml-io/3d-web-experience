...
// TODO: (probably not TBH)
// I don't like this. Shader patching can break on threejs updates because they
// might change the order of chunks for the standard mats. This will do for now,
// but it will for sure bite us in the ass later.
