...
export class Composer {
  ...
  //   this.playcanvasScene.backgroundRotation = new Euler(
  //     MathUtils.degToRad(envValues.skyboxPolarAngle),
  //     MathUtils.degToRad(envValues.skyboxAzimuthalAngle),
  //     0,
  //   );
  //   this.playcanvasScene.environmentRotation = new Euler(
  //     MathUtils.degToRad(envValues.skyboxPolarAngle),
  //     MathUtils.degToRad(envValues.skyboxAzimuthalAngle),
  //     0,
  //   );
  ...
  //   );
  //   this.playcanvasScene.fog = new Fog(fogColor, envValues.fog.fogNear, envValues.fog.fogFar);
  // }
  //
  // public setAmbientLight(): void {
  //   if (this.ambientLight) {
  //     this.playcanvasScene.remove(this.ambientLight);
  ...
  //   );
  //   this.playcanvasScene.add(this.ambientLight);
  //
  //   if (ambientLightIntensity < 0) {
  //     this.playcanvasScene.ambientLuminance = 0;
  //     this.playcanvasScene.ambientLight = new playcanvas.Color(0, 0, 0);
  //   } else {
  ...
  //       b: 1,
  //     });
  //     this.playcanvasScene.ambientLuminance = ambientLightIntensity * 20;
  //     this.playcanvasScene.ambientLight = new playcanvas.Color(
  ...
  //   }
  //   this.playcanvasScene.environmentIntensity = envValues.envMapIntensity;
  //
  ...
  //   }
  //   this.playcanvasScene.backgroundIntensity = envValues.skyboxIntensity;
  //
  ...
  //   this.playcanvasScene.environment = envMap;
  //   this.playcanvasScene.environmentIntensity = envValues.envMapIntensity;
  //   this.playcanvasScene.environmentRotation = new Euler(
  //     MathUtils.degToRad(envValues.skyboxPolarAngle),
  //     MathUtils.degToRad(envValues.skyboxAzimuthalAngle),
  //     0,
  //   );
  //   this.playcanvasScene.background = envMap;
  //   this.playcanvasScene.backgroundIntensity = envValues.skyboxIntensity;
  //   this.playcanvasScene.backgroundBlurriness = envValues.skyboxBlurriness;
  //   this.playcanvasScene.backgroundRotation = new Euler(
  //     MathUtils.degToRad(envValues.skyboxPolarAngle),
  //     MathUtils.degToRad(envValues.skyboxAzimuthalAngle),
  //     0,
