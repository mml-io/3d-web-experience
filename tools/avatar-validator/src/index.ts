...
import hdrBase64 from "../../../example/assets/hdr/industrial_sunset_2k.hdr";
import airAnimationFileBase64 from "../../../example/assets/models/unreal-air.glb";
import idleAnimationFileBase64 from "../../../example/assets/models/unreal-idle.glb";
import jogAnimationFileBase64 from "../../../example/assets/models/unreal-jog.glb";
import meshFileBase64 from "../../../example/assets/models/unreal-mesh.glb";
import sprintAnimationFileBase64 from "../../../example/assets/models/unreal-run.glb";

import { Room } from "./Room";

const characterDescription: CharacterDescription = {
  airAnimationFileUrl: "data:model/glb;base64," + airAnimationFileBase64,
  idleAnimationFileUrl: "data:model/glb;base64," + idleAnimationFileBase64,
  jogAnimationFileUrl: "data:model/glb;base64," + jogAnimationFileBase64,
  meshFileUrl: "data:model/glb;base64," + meshFileBase64,
  sprintAnimationFileUrl: "data:model/glb;base64," + sprintAnimationFileBase64,
  modelScale: 1,
};
...
class App {
  ...
  constructor() {
    ...
    this.composer.useHDRI("data:text/plain;base64," + hdrBase64);
